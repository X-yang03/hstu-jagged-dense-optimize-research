...
from fused_hstu_v4.fused_backward_v4 import fused_backward_simpler
from fused_hstu_v4.fused_hstu_v4 import fused_jagged_hstu
# 在改善nan的bug后发现，simpler版本的backward更快，因此将backward的代码改为simpler版本
class FusedHSTUOpv4(torch.autograd.Function):
